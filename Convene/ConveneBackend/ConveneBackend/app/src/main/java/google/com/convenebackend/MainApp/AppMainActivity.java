...
import google.com.convenebackend.MainApp.GetLocation;
import google.com.convenebackend.MainApp.MapsActivity;
...
public class AppMainActivity extends AppCompatActivity {
    ...
    public final static String EXTRA_MESSAGE = "google.com.convenebackend.MainApp.MESSAGE";
    ...
    class ViewPagerAdapter extends FragmentStatePagerAdapter {
        ...
        private final List<FragmentActivity> mFragmentList1 = new ArrayList<>();
        ...
        public void addFragment1(FragmentActivity fragment, String title) {
    ...
    public void getLocation(View view) {
        ...
        ViewPagerAdapter mAdapter = new ViewPagerAdapter(getSupportFragmentManager());
        mAdapter.addFragment(new OneFragment(), "");
       // mAdapter.addFragment1(new mapsFragment(), "");
        mAdapter.addFragment(new ThreeFragment(), "");
